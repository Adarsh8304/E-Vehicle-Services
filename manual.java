...
//		JPanel solapur = new JPanel();
		...
		lblNewLabel_5.setBounds(1380, 443, 52, 39);
		...
		eiid = new JTextField();
		eiid.setFont(new Font("Tahoma", Font.BOLD, 12));
	 ...
	 servity.addItemListener(new ItemListener() {
		...
		servity.setModel(new DefaultComboBoxModel(new String[] {"", "Manual Testing", "AC Repair", "Batteries", "Coolant & Oil Change"}));
		contentPane.add(servity);
		
		vehino = new JTextField();
		vehino.setFont(new Font("Tahoma", Font.BOLD, 12));
...
//					em.emailservice(email);
		...
		btnNewButton.setBounds(1098, 539, 212, 33);
